...
func (m *mockContribRepo) FindByTxnHash(_ context.Context, _ string) (*contribution.Contribution, error) {
	return nil, nil
}
...
func (m *mockPayoutRepo) FindByTxnHash(_ context.Context, _ string) (*payout.Payout, error) {
	return nil, nil
}
